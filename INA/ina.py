...
# =============================================================================
# Cell 5: Fourier Feature Encoding
# =============================================================================
class FourierFeatureEncoding(nn.Module):
    ...
    """
    def __init__(self, in_features, num_frequencies=256, scale=10.0):
        super().__init__()
...
model_siren = Siren(in_features=2, out_features=1, hidden_features=256,
                    hidden_layers=3, outermost_linear=True).to(device)
psnr_siren = train(model_siren, img, dataloader, device=device, output_dir="./siren/", lr=1e-4)
...
class INR(nn.Module):
    ...
    Uses Fourier feature encoding by default for fair comparison with SIREN.
    """

    def __init__(self, in_features, hidden_features, hidden_layers, out_features,
                 activation_fn_factory, outermost_linear=True, init='kaiming',
                 use_encoding=True, num_frequencies=256, encoding_scale=10.0):
        super().__init__()

        # Optional positional encoding
        self.encoding = None
        actual_in = in_features
        if use_encoding:
            self.encoding = FourierFeatureEncoding(in_features, num_frequencies, encoding_scale)
            actual_in = self.encoding.out_features
...
# =============================================================================
# Cell 14: ZiLU Approx Activation
# =============================================================================
...
labels = ['SIREN', 'ReLU', 'GELU', 'SiLU', 'ZiLU', 'ZiLU-Approx']
histories = [psnr_siren, psnr_relu, psnr_gelu, psnr_silu, psnr_zailu, psnr_zailu_approx]
...
ax.set_title("Image Fitting: PSNR Comparison Across Activations", fontsize=16)
...
# =============================================================================
# Cell 18: Side-by-Side Final Reconstructions
# =============================================================================
...
plt.suptitle("Final Reconstructions (500 steps)", fontsize=18)
plt.tight_layout()
